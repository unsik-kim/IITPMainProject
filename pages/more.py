                            ...
                            html.Div(
                                [
                                    ...
                                    html.Div(
                                        [
                                            html.P(
                                                "향후 의사 수를 예측하기 위해선 현재 국내 의사 수의 구조를 구체적으로 파악해야 한다. 하지만 현재 공개된 의사 수 데이터는 연도별/성별 의사 수만 존재하여 향후 의사수를 예측하기에 어려움이 있다."
                                            ),
                                            html.P(
                                                "[사용 데이터]를 이용하여 연도별/성별/연령별 의사 수 데이터를 추론할 수 있는 모델을 설계하고 적용하여 과거, 현재 그리고 미래의 의사인력 구조를 추론하고 분석하고자 한다."
                                            ),
                                        ],
                                        style={"color": "#7a7a7a"},
                                    ),
