                ...
                [
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    즉, 의사인력의 공급정책을 결정하는 것에 있어서 증원하는 의사의 숫자만 중요한 것이 아니라 이탈되는 인력의 수, 우리나라 인구 분포 등의 다방면의 요인을 파악하고 반영하여 매해 적절한 의료 인력 수급에 맞는 정책을 세워야 한다는 것이 의료 인력 문제의 주요 골자이다.\
                                        ",
                                        style={"color": "#ffffff"},
                                        className="row",
                                    ),
                    ...
                    html.Div(
                        [
                            html.Div(
                                [
                                    html.H5("[‘의사 생애 주기 모델’을 통한 현존 의사의 특성 파악 및 미래 의사 인력 예측]"),
                                    html.Br([]),
                                    html.Img(src='https://github.com/unsik-kim/IITPMainProject/blob/master/pic2.PNG?raw=true', style={'margin-left': '3%','margin-right': '3%','margin-bottom': '2%','width': '60%', 'float':'left'}),
                                    html.P(
                                        "\
                                        ...
                                        따라서, 본 연구에서는 앞에서 제시한 문제를 해결하고, 정부의 적절한 보건 의료 인력 수급 정책 마련에 도움이 되고자 ‘국내 의사 인력 추정을 위한 상세 모형 개발’을 주제로 선정하였다.",
                                        style={"color": "#ffffff", "text-size":'14px'},
                                        className="row",
                                    ),
                                ],
                                className="product",
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    html.Div(
                                        [
                                            html.Img(src=app.get_asset_url("pic2.jpg"), 
