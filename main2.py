...
sidebar = html.Div(
    [
        html.H3("의료인력 분석", className="display-4"),
        html.Hr(),
        html.P(
            "IDD 이슈에 데이터로 답하다", className="lead"
        ),
        dbc.Nav(
            [
                dbc.NavLink("전체 의사 수", href="/page-1", id="page-1-link"),
                dbc.NavLink("신규 의사 수", href="/page-2", id="page-2-link"),
                dbc.NavLink("은퇴 의사 수", href="/page-3", id="page-3-link"),
                dbc.NavLink("사망 의사 수", href="/page-4", id="page-4-link"),
            ],
            vertical=True,
            pills=True,
        ),
    ...
    if pathname == "/":
        ...
        return html.Div(
            children=[
                ...
                dcc.Slider(id='td-year-slider',min=1952,max=2047,value=2018,marks={i: '{}'.format(i) for i in range(1952,2047)},step=1)
            ])
        ...
        return html.Div(
            children=[
                ...
                dcc.Slider(id='nd-year-slider',min=1952,max=2047,value=2018,marks={i: '{}'.format(i) for i in range(1952,2047)},step=1)
            ])
        ...
        return html.Div(
            children=[
                ...
                dcc.Slider(id='rd-year-slider',min=1952,max=2047,value=2018,marks={i: '{}'.format(i) for i in range(1952,2047)},step=1)
            ])
        ...
        return html.Div(
            children=[
                ...
                dcc.Slider(id='dd-year-slider',min=1952,max=2047,value=2018,marks={i: '{}'.format(i) for i in range(1952,2047)},step=1)
            ])
